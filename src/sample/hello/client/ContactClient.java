...
public class ContactClient {
	...
	public static void main(String[] args) {
		...
		WebResource r = c.resource("http://localhost:8080/restful-test/rest/contacts");
		
		System.out.println("===== Get Midalas =====");
		getOneContact(r, "Midalas");
		
		System.out.println("===== Create foo =====");
		postForm(r, "foo", "bar");
		
		Address[] addrs = {
			new Address("Wuhan", "He Ping Street")
		};
